...
public class ReportFilterLabelConditionView extends FilterLabelConditionView {

	public ReportFilterLabelConditionView(Context context) {
		super(context);
	}
    public ReportFilterLabelConditionView(Context context, AttributeSet attrs) {
        super(context,attrs);
    }
	...
	public void resetView(){
		...
		List<FieldDescriptDALEx> descripts = FieldDescriptDALEx.get().queryByEntityregname(ExpandinfoDALEx.Name_Logistics);

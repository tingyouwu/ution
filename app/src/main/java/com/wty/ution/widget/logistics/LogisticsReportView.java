package com.wty.ution.widget.logistics;
...
@SuppressLint("NewApi")
public class LogisticsReportView extends LinearLayout{
    ...
    ReportButton btn_logistics_month_amount;
    ReportButton btn_logistics_month_money;
    ReportButton btn_logistics_today_amount;
    ReportButton btn_logistics_today_money;
...
//    }
	...
	public LogisticsReportView(Context context, AttributeSet attrs) {
		super(context, attrs);
        LayoutInflater.from(getContext()).inflate(R.layout.layout_logistics_report, this);
        ButterKnife.bind(this);

        View page_1 = LayoutInflater.from(getContext()).inflate(R.layout.view_crm_report_1,null);
//        View page_2 = LayoutInflater.from(getContext()).inflate(R.layout.view_crm_report_2,null);

        btn_logistics_month_amount = (ReportButton)page_1.findViewById(R.id.logistics_month_amount);
        btn_logistics_month_money = (ReportButton)page_1.findViewById(R.id.logistics_month_money);
        btn_logistics_today_amount = (ReportButton)page_1.findViewById(R.id.logistics_today_amount);
        btn_logistics_today_money = (ReportButton)page_1.findViewById(R.id.logistics_today_money);
    ...
    public void refresh() {
        ...
        simpletask = new SimpleTask() {
            ...
            protected Object doInBackground(String... params) {
                monthAmount = LogisticsDALEx.get().countCurrentMonthAmount();
                todayAmount = LogisticsDALEx.get().countTodayAmount();
                monthMoney = LogisticsDALEx.get().countCurrentMonthMoney();
                todayMoney = LogisticsDALEx.get().countTodayMoney();
                return "";
            }

            @Override
            protected void onPostExecute(Object o) {
                btn_logistics_month_amount.setCount(monthAmount);
                btn_logistics_today_amount.setCount(todayAmount);
                btn_logistics_month_money.setCount(monthMoney);
                btn_logistics_today_money.setCount(todayMoney);
            }
        };

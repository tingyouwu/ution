...
import com.wty.ution.data.annotation.bmob.BmobAnnotationField;
import com.wty.ution.data.annotation.bmob.BmobAnnotationTable;
...
public abstract class BaseBmobObject extends BmobObject {
    ...
    public List<BmobAnnotationField> getBmobAnnotationField(){
        BmobAnnotationCache cache = UtionObjectCache.getInstance().getBmobAnnotationCache();

...
@SuppressLint("NewApi")
public class UtionDB extends SQLiteOpenHelper  {

	private Context context;

	public UtionDB(Context context) {
		super(context, AppContext.getInstance().getDBname(), null, AppContext.getDbVersion(context));
